...
/*      console.log("Sending message to channel ", message.channel, ", # users:", clients.length);*/
      for(var x=0, len2 = clients.length; x < len2; x++) {
/*        console.log("Sending message to", clients[x].session_id, ", connected?", clients[x].connection.stream.connected);*/
...
/*    console.log("Adding users to channel ", this.name, ", # users:", this.clients.length);*/
